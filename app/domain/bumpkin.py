# app/domain/bumpkin.py
"""
Este módulo contém os dados e a lógica para lidar com os itens
e a imagem do Bumpkin. Os dados são mantidos estaticamente aqui
para garantir robustez e evitar a leitura de arquivos externos.
"""

# NOVO: Dicionário para mapear o nome da parte do corpo para a sua posição (slot).
# Essencial para a nova lógica de construção de URL.
SLOTS_ORDER = {
...
# A ordem exata em que os IDs devem ser montados na URL da imagem
PART_ORDER = [
    "background", "body", "hair", "shirt", "pants", "shoes", "tool",
    "hat", "necklace", "secondaryTool", "coat", "onesie", "suit",
    "wings", "dress", "beard", "aura"
]

# Mapeamento completo e atualizado de nomes de itens para seus IDs numéricos.
# Fonte: bumpkin (1).ts, a versão mais recente fornecida.
ITEM_IDS = {
